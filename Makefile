...
TOPDIR = $(shell pwd)
DATE="date +%Y%m%d"
PROGRAMNAME=kermit-mcollective-plugins
VERSION=$(shell grep "Version:" ./misc/specs/kermit-mcollective-plugins.spec)
...
clean_rpms:
	-rpm -e kermit-mcollective-plugins
...
rpms: build manpage sdist
	...
	--define "vendor Think" \
	-ba misc/specs/kermit-mcollective-plugins.spec
