...
metadata     :name        => "Manage JBoss AS 7",
             :description => "Jboss AS 7 inventory and app. deployment",
...
action "get_app_backups", :description => "Get backups file list for provided application" do
    display :always
